export const SvgLogo = {
  wheat: (props) => (
    <svg
      ...
      height={props?.height || props?.width || "45"}
      viewBox="0 0 512 512"
      fill="none"
  ...
  sproutsIcons: (props) => (
    <svg
      width={props?.width || "45"}
      height={props?.height || props?.width || "45"}
      viewBox="0 0 512 512" // Sesuaikan dengan viewbox asli dari base64
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className={props?.className || ""}
      style={props?.style}
  ...
  javascript: (props) => {
    // Intercept prop size agar bisa dipakai di width & height sekaligus
    const finalWidth = props?.size || props?.width || "45";
    const finalHeight = props?.size || props?.height || props?.width || "45";
    return (
      <svg
        width={finalWidth}
        height={finalHeight}
      ...
      >
        ...
        {/* Path Huruf J dan S Tebal Murni dari Base64 Terbaru Lu */}
        <path
          fill={props?.fill || "currentColor"}
          d="M7.5 15q-.625 0-1.062-.437T6 13.5v-1h1.5v1H9V9h1.5v4.5q0 .625-.437 1.063T9 15zm5.5 0q-.425 0-.712-.288T12 14v-1h1.5v.5h2v-1H13q-.425 0-.712-.288T12 11.5V10q0-.425.288-.712T13 9h3q.425 0 .713.288T17 10v1h-1.5v-.5h-2v1H16q.425 0 .713.288T17 12.5V14q0 .425-.288.713T16 15z"
        />
      </svg>
    );
  },
